...
func (o *Capability) GetModelPoolId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Capability) GetModelPoolIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Capability) HasModelPoolId() bool {
...
func (o *Capability) UnsetModelPoolId() {
	o.ModelPoolId.Unset()
}
