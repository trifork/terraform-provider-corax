...
type Data struct {
	...
	VertexAiProviderWithDeploymentsCreate *VertexAiProviderWithDeploymentsCreate
}
...
func (dst *Data) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonAzureAiProviderWithDeploymentsCreate) == "{}" { // empty struct
			dst.AzureAiProviderWithDeploymentsCreate = nil
		} else {
			return nil // data stored in dst.AzureAiProviderWithDeploymentsCreate, return on the first match
		}
	} else {
		dst.AzureAiProviderWithDeploymentsCreate = nil
	}
	...
	// try to unmarshal JSON data into VertexAiProviderWithDeploymentsCreate
	err = json.Unmarshal(data, &dst.VertexAiProviderWithDeploymentsCreate);
	if err == nil {
		jsonVertexAiProviderWithDeploymentsCreate, _ := json.Marshal(dst.VertexAiProviderWithDeploymentsCreate)
		if string(jsonVertexAiProviderWithDeploymentsCreate) == "{}" { // empty struct
			dst.VertexAiProviderWithDeploymentsCreate = nil
		} else {
			return nil // data stored in dst.VertexAiProviderWithDeploymentsCreate, return on the first match
		}
	} else {
		dst.VertexAiProviderWithDeploymentsCreate = nil
	}
...
func (src Data) MarshalJSON() ([]byte, error) {
	...
	if src.AzureAiProviderWithDeploymentsCreate != nil {
		return json.Marshal(&src.AzureAiProviderWithDeploymentsCreate)
	}
	...
	if src.VertexAiProviderWithDeploymentsCreate != nil {
		return json.Marshal(&src.VertexAiProviderWithDeploymentsCreate)
	}
