...
func (o *PolicyUpdate) GetScopeIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyUpdate) GetScopeIdsOk() ([]string, bool) {
...
func (o *PolicyUpdate) HasScopeIds() bool {
	if o != nil && !IsNil(o.ScopeIds) {
		return true
	}
...
func (o *PolicyUpdate) SetScopeIds(v []string) {
	o.ScopeIds = v
}
