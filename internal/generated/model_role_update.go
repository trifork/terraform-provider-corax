...
func (o *RoleUpdate) SetDescriptionNil() {
	o.Description.Set(nil)
}

// UnsetDescription ensures that no value is present for Description, not even an explicit nil
func (o *RoleUpdate) UnsetDescription() {
	o.Description.Unset()
}

// GetPermissions returns the Permissions field value if set, zero value otherwise.
func (o *RoleUpdate) GetPermissions() []Permission {
...
// and a boolean to check if the value has been set.
func (o *RoleUpdate) GetPermissionsOk() ([]Permission, bool) {
	if o == nil || IsNil(o.Permissions) {
		return nil, false
	}
...
func (o *RoleUpdate) SetPermissions(v []Permission) {
	o.Permissions = v
}
