...
func (o *ConfigurationField) GetStep() Step {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConfigurationField) GetStepOk() (*Step, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigurationField) HasStep() bool {
...
// SetStep gets a reference to the given NullableStep and assigns it to the Step field.
...
func (o *ConfigurationField) UnsetStep() {
	o.Step.Unset()
}
