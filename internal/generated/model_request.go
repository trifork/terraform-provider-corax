...
type Request struct {
	...
	VertexAiProviderValidationRequest *VertexAiProviderValidationRequest
}
...
func (dst *Request) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal JSON data into VertexAiProviderValidationRequest
	err = json.Unmarshal(data, &dst.VertexAiProviderValidationRequest);
	if err == nil {
		jsonVertexAiProviderValidationRequest, _ := json.Marshal(dst.VertexAiProviderValidationRequest)
		if string(jsonVertexAiProviderValidationRequest) == "{}" { // empty struct
			dst.VertexAiProviderValidationRequest = nil
		} else {
			return nil // data stored in dst.VertexAiProviderValidationRequest, return on the first match
		}
	} else {
		dst.VertexAiProviderValidationRequest = nil
	}
...
func (src Request) MarshalJSON() ([]byte, error) {
	...
	if src.VertexAiProviderValidationRequest != nil {
		return json.Marshal(&src.VertexAiProviderValidationRequest)
	}
