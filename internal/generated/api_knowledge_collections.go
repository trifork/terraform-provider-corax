...
type KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest struct {
	ctx context.Context
	ApiService *KnowledgeCollectionsAPIService
	collectionId string
	documentId string
...
func (r KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.DownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetExecute(r)
}

/*
DownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGet Download extracted document text (Markdown)

Download the extracted text (Markdown) for a document from object storage.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param collectionId
 @param documentId
 @return KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest
*/
func (a *KnowledgeCollectionsAPIService) DownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGet(ctx context.Context, collectionId string, documentId string) KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest {
	return KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest{
		ApiService: a,
		ctx: ctx,
		collectionId: collectionId,
...
// Execute executes the request
//  @return interface{}
func (a *KnowledgeCollectionsAPIService) DownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetExecute(r KnowledgeCollectionsAPIDownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGetRequest) (interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KnowledgeCollectionsAPIService.DownloadDocumentTextV1CollectionsCollectionIdDocumentsDocumentIdTextGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/collections/{collection_id}/documents/{document_id}/text"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"document_id"+"}", url.PathEscape(parameterValueToString(r.documentId, "documentId")), -1)
...
type KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest struct {
	ctx context.Context
	ApiService *KnowledgeCollectionsAPIService
	collectionId string
	documentId string
...
func (r KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.DownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetExecute(r)
}

/*
DownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGet Download original document

Download the original uploaded file from object storage.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param collectionId
 @param documentId
 @return KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest
*/
func (a *KnowledgeCollectionsAPIService) DownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGet(ctx context.Context, collectionId string, documentId string) KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest {
	return KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest{
		ApiService: a,
		ctx: ctx,
		collectionId: collectionId,
...
// Execute executes the request
//  @return *os.File
func (a *KnowledgeCollectionsAPIService) DownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetExecute(r KnowledgeCollectionsAPIDownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGetRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KnowledgeCollectionsAPIService.DownloadDocumentV1CollectionsCollectionIdDocumentsDocumentIdDownloadGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/collections/{collection_id}/documents/{document_id}/download"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"document_id"+"}", url.PathEscape(parameterValueToString(r.documentId, "documentId")), -1)
...
func (r KnowledgeCollectionsAPIEmbedDocumentsToCollectionAsyncV1CollectionsCollectionIdEmbedPostRequest) Files(files []string) KnowledgeCollectionsAPIEmbedDocumentsToCollectionAsyncV1CollectionsCollectionIdEmbedPostRequest {
	r.files = &files
	return r
}
...
func (a *KnowledgeCollectionsAPIService) EmbedDocumentsToCollectionAsyncV1CollectionsCollectionIdEmbedPostExecute(r KnowledgeCollectionsAPIEmbedDocumentsToCollectionAsyncV1CollectionsCollectionIdEmbedPostRequest) (*DocumentEmbeddingResponse, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarFormParams, "files", r.files, "", "csv")
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["APIKeyHeader"]; ok {
