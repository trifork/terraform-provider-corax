...
func (r ModelProvidersAPICreateModelProviderWithDeploymentsV1ModelProvidersWithDeploymentsPostRequest) Execute() (*ModelProvider, *http.Response, error) {
	return r.ApiService.CreateModelProviderWithDeploymentsV1ModelProvidersWithDeploymentsPostExecute(r)
}

/*
CreateModelProviderWithDeploymentsV1ModelProvidersWithDeploymentsPost Create Model Provider With Deployments

Create a model provider with multiple deployments in a single transaction.
...
func (a *ModelProvidersAPIService) CreateModelProviderWithDeploymentsV1ModelProvidersWithDeploymentsPostExecute(r ModelProvidersAPICreateModelProviderWithDeploymentsV1ModelProvidersWithDeploymentsPostRequest) (*ModelProvider, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/model-providers/with-deployments"
...
func (r ModelProvidersAPIGetProviderHealthV1ModelProvidersProviderIdHealthGetRequest) Execute() (*ProviderHealthResponse, *http.Response, error) {
	return r.ApiService.GetProviderHealthV1ModelProvidersProviderIdHealthGetExecute(r)
}

/*
GetProviderHealthV1ModelProvidersProviderIdHealthGet Get Provider Health
...
func (a *ModelProvidersAPIService) GetProviderHealthV1ModelProvidersProviderIdHealthGetExecute(r ModelProvidersAPIGetProviderHealthV1ModelProvidersProviderIdHealthGetRequest) (*ProviderHealthResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/model-providers/{provider_id}/health"
	localVarPath = strings.Replace(localVarPath, "{"+"provider_id"+"}", url.PathEscape(parameterValueToString(r.providerId, "providerId")), -1)
...
func (r ModelProvidersAPIListAvailableModelsV1ModelProvidersProviderIdAvailableModelsGetRequest) Execute() (*ProviderValidationResponse, *http.Response, error) {
	return r.ApiService.ListAvailableModelsV1ModelProvidersProviderIdAvailableModelsGetExecute(r)
}

/*
ListAvailableModelsV1ModelProvidersProviderIdAvailableModelsGet List Available Models
...
func (a *ModelProvidersAPIService) ListAvailableModelsV1ModelProvidersProviderIdAvailableModelsGetExecute(r ModelProvidersAPIListAvailableModelsV1ModelProvidersProviderIdAvailableModelsGetRequest) (*ProviderValidationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/model-providers/{provider_id}/available-models"
	localVarPath = strings.Replace(localVarPath, "{"+"provider_id"+"}", url.PathEscape(parameterValueToString(r.providerId, "providerId")), -1)
...
func (r ModelProvidersAPITriggerProviderHealthCheckV1ModelProvidersProviderIdHealthCheckPostRequest) Execute() (*ProviderHealthResponse, *http.Response, error) {
	return r.ApiService.TriggerProviderHealthCheckV1ModelProvidersProviderIdHealthCheckPostExecute(r)
}

/*
TriggerProviderHealthCheckV1ModelProvidersProviderIdHealthCheckPost Trigger Provider Health Check
...
func (a *ModelProvidersAPIService) TriggerProviderHealthCheckV1ModelProvidersProviderIdHealthCheckPostExecute(r ModelProvidersAPITriggerProviderHealthCheckV1ModelProvidersProviderIdHealthCheckPostRequest) (*ProviderHealthResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/model-providers/{provider_id}/health-check"
	localVarPath = strings.Replace(localVarPath, "{"+"provider_id"+"}", url.PathEscape(parameterValueToString(r.providerId, "providerId")), -1)
