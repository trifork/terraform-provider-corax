...
func (o *PolicyResponse) GetScopeIds() []string {
...
// and a boolean to check if the value has been set.
func (o *PolicyResponse) GetScopeIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.ScopeIds) {
		return nil, false
	}
...
func (o *PolicyResponse) HasScopeIds() bool {
	if o != nil && !IsNil(o.ScopeIds) {
		return true
	}
...
func (o *PolicyResponse) SetScopeIds(v []string) {
	o.ScopeIds = v
}
