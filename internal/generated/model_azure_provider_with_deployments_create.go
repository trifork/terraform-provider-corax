...
func (o *AzureProviderWithDeploymentsCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureProviderWithDeploymentsCreate := _AzureProviderWithDeploymentsCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureProviderWithDeploymentsCreate)

	if err != nil {
		return err
	}

	*o = AzureProviderWithDeploymentsCreate(varAzureProviderWithDeploymentsCreate)
