...
func (o *PolicyCreate) GetScopeIds() []string {
...
// and a boolean to check if the value has been set.
func (o *PolicyCreate) GetScopeIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.ScopeIds) {
		return nil, false
	}
...
func (o *PolicyCreate) HasScopeIds() bool {
	if o != nil && !IsNil(o.ScopeIds) {
		return true
	}
...
func (o *PolicyCreate) SetScopeIds(v []string) {
	o.ScopeIds = v
}
