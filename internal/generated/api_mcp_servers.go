...
type MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest struct {
	ctx context.Context
...
func (r MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest) MCPToolCallRequest(mCPToolCallRequest MCPToolCallRequest) MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest {
	r.mCPToolCallRequest = &mCPToolCallRequest
	return r
}

func (r MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest) Execute() (*MCPToolCallResponse, *http.Response, error) {
	return r.ApiService.CallMcpServerToolV1McpServersServerIdToolsCallPostExecute(r)
}

/*
CallMcpServerToolV1McpServersServerIdToolsCallPost Call a tool directly on an MCP server
...
Execute a tool directly on an MCP server. This is used by MCP App iframes to proxy tool calls through the backend.
 ...
 @param serverId
 @return MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest
*/
func (a *MCPServersAPIService) CallMcpServerToolV1McpServersServerIdToolsCallPost(ctx context.Context, serverId string) MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest {
	return MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
func (a *MCPServersAPIService) CallMcpServerToolV1McpServersServerIdToolsCallPostExecute(r MCPServersAPICallMcpServerToolV1McpServersServerIdToolsCallPostRequest) (*MCPToolCallResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MCPToolCallResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MCPServersAPIService.CallMcpServerToolV1McpServersServerIdToolsCallPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/mcp-servers/{server_id}/tools/call"
	...
	if r.mCPToolCallRequest == nil {
		return localVarReturnValue, nil, reportError("mCPToolCallRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.mCPToolCallRequest
	if r.ctx != nil {
...
type MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest struct {
	ctx context.Context
	ApiService *MCPServersAPIService
}

func (r MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest) Execute() (*MCPConfigSchemaResponse, *http.Response, error) {
	return r.ApiService.GetMcpConfigSchemaV1McpServersConfigSchemaGetExecute(r)
}

/*
GetMcpConfigSchemaV1McpServersConfigSchemaGet Get the MCP server config schema
...
Return the renderable form schema for the MCP server editor: base server fields and the supported authentication modes with their fields, defaults and validation hints. The frontend builds the auth section from this instead of hardcoding the modes.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest
*/
func (a *MCPServersAPIService) GetMcpConfigSchemaV1McpServersConfigSchemaGet(ctx context.Context) MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest {
	return MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MCPConfigSchemaResponse
func (a *MCPServersAPIService) GetMcpConfigSchemaV1McpServersConfigSchemaGetExecute(r MCPServersAPIGetMcpConfigSchemaV1McpServersConfigSchemaGetRequest) (*MCPConfigSchemaResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MCPConfigSchemaResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MCPServersAPIService.GetMcpConfigSchemaV1McpServersConfigSchemaGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/mcp-servers/config-schema"
...
type MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest struct {
	ctx context.Context
	ApiService *MCPServersAPIService
	serverId string
}

func (r MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest) Execute() ([]ConnectedCapabilityResponse, *http.Response, error) {
	return r.ApiService.GetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetExecute(r)
}

/*
GetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGet Get capabilities connected to this MCP server
...
Retrieve all capabilities that reference this MCP server. Only the server owner can view this information. Useful for impact analysis before changing server visibility.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serverId
 @return MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest
*/
func (a *MCPServersAPIService) GetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGet(ctx context.Context, serverId string) MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest {
	return MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
// Execute executes the request
//  @return []ConnectedCapabilityResponse
func (a *MCPServersAPIService) GetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetExecute(r MCPServersAPIGetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGetRequest) ([]ConnectedCapabilityResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ConnectedCapabilityResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MCPServersAPIService.GetMcpServerConnectedCapabilitiesV1McpServersServerIdConnectedCapabilitiesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/mcp-servers/{server_id}/connected-capabilities"
	localVarPath = strings.Replace(localVarPath, "{"+"server_id"+"}", url.PathEscape(parameterValueToString(r.serverId, "serverId")), -1)
...
type MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest struct {
	ctx context.Context
	ApiService *MCPServersAPIService
	serverId string
	mCPResourceReadRequest *MCPResourceReadRequest
}

func (r MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest) MCPResourceReadRequest(mCPResourceReadRequest MCPResourceReadRequest) MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest {
	r.mCPResourceReadRequest = &mCPResourceReadRequest
	return r
}

func (r MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest) Execute() (*MCPResourceReadResponse, *http.Response, error) {
	return r.ApiService.ReadMcpServerResourceV1McpServersServerIdResourcesReadPostExecute(r)
}

/*
ReadMcpServerResourceV1McpServersServerIdResourcesReadPost Read a resource from an MCP server
...
Read a specific resource from an MCP server by its URI. This is used by MCP App iframes to fetch HTML content for rendering.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serverId
 @return MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest
*/
func (a *MCPServersAPIService) ReadMcpServerResourceV1McpServersServerIdResourcesReadPost(ctx context.Context, serverId string) MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest {
	return MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
func (a *MCPServersAPIService) ReadMcpServerResourceV1McpServersServerIdResourcesReadPostExecute(r MCPServersAPIReadMcpServerResourceV1McpServersServerIdResourcesReadPostRequest) (*MCPResourceReadResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MCPResourceReadResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MCPServersAPIService.ReadMcpServerResourceV1McpServersServerIdResourcesReadPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/mcp-servers/{server_id}/resources/read"
	localVarPath = strings.Replace(localVarPath, "{"+"server_id"+"}", url.PathEscape(parameterValueToString(r.serverId, "serverId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.mCPResourceReadRequest == nil {
		return localVarReturnValue, nil, reportError("mCPResourceReadRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.mCPResourceReadRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["APIKeyHeader"]; ok {
